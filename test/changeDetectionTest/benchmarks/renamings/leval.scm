...
(<insert> (define lazy? (lambda (v) (tagged-list? v 'lazy)))) ; <====================================================
(<insert> (define memo?  (lambda (v) (tagged-list? v 'lazy-memo)))) ; <===============================================
(<insert> (define tagged-declaration? pair?)) ; <====================================================================
(<insert> (define parameter-name  (lambda (v) (if (tagged-declaration? v) (cadr v) v)))) ; <==========================
(<insert> (define first-variable  car)) ; <===========================================================================
(<insert> (define rest-variables  cdr)) ; <===========================================================================
(<insert> (define thunk-memoizable?  (lambda (v) (tagged-list? v 'thunk-memoizable)))) ; <============================
...
;; zie deel 3 p12
;;
(define eval-if (lambda ((<update> exp expression) env)
  (if (true? (actual-value (if-predicate (<update> exp expression)) env))
      (eval (if-consequent (<update> exp expression)) env)
      (eval (if-alternative (<update> exp expression)) env))))
