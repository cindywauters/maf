...
(define lazy? (lambda (v) (tagged-list? v 'lazy))) ; <====================================================
(define memo?  (lambda (v) (tagged-list? v 'lazy-memo))) ; <===============================================
(define tagged-declaration? pair?) ; <====================================================================
(define parameter-name  (lambda (v) (if (tagged-declaration? v) (cadr v) v))) ; <==========================
(define first-variable  car) ; <===========================================================================
(define rest-variables  cdr) ; <===========================================================================
(define thunk-memoizable?  (lambda (v) (tagged-list? v 'thunk-memoizable))) ; <============================
