         ...
         (let ((x (lookup key1 properties)))
            (if x
               (let ((y (lookup key2 (cdr x))))
                  (if y (cdr y) #f))
               #f)))
      (lambda (_key10 _key20)
         (let ((_x0 (lookup _key10 properties)))
            (if _x0
               (let ((_y0 (lookup _key20 (cdr _x0))))
                  (if _y0 (cdr _y0) #f))
               #f)))))
...
(define put (<change>
      ...
      (lambda (_key10 _key20 _val0)
         (let ((_x0 (lookup _key10 properties)))
            (if _x0
               (let ((_y0 (lookup _key20 (cdr _x0))))
                  (if _y0
                     (set-cdr! _y0 _val0)
                     (set-cdr! _x0 (cons (cons _key20 _val0) (cdr _x0)))))
               (set! properties (cons (list _key10 (cons _key20 _val0)) properties)))))))
 
(define *current-gensym* 0)
 
(define generate-symbol (lambda ()
...
(define tree-copy (<change>
      ...
      (lambda (_x0)
         (if (not (pair? _x0))
            _x0
            (cons (tree-copy (car _x0)) (tree-copy (cdr _x0)))))))
...
(define init (<change>
      ...
      (lambda (_n0 _m0 _npats0 _ipats0)
         (let ((_ipats1 (tree-copy _ipats0)))
            (letrec ((___do_loop0 (lambda (_p0)
                                    (if (null? (cdr _p0))
                                       (set-cdr! _p0 _ipats1)
                                       (___do_loop0 (cdr _p0))))))
               (___do_loop0 _ipats1))
            (letrec ((___do_loop1 (lambda (_n1 _i0 _name0 _a0)
                                    (if (= _n1 0)
                                       _a0
                                       (begin
                                          (set! _a0 (cons _name0 _a0))
                                          (letrec ((___do_loop2 (lambda (_i1)
                                                                  (if (zero? _i1)
                                                                     #f
                                                                     (begin
                                          ...
                                          (put
                                             _name0
                                             'pattern
                                             (letrec ((___do_loop3 (lambda (_i2 _ipats2 _a1)
                                                                     (if (zero? _i2)
                                                                        _a1
                                                                        (begin
                                                                           (set! _a1 (cons (car _ipats2) _a1))
                                                                           (___do_loop3 (- _i2 1) (cdr _ipats2) _a1))))))
                                                (___do_loop3 _npats0 _ipats1 ())))
                                          (letrec ((___do_loop4 (lambda (_j0)
                                                                  (if (zero? _j0)
                                                                     #f
                                                                     (begin
                                                                        (put _name0 (generate-symbol) #f)
                                                                        (___do_loop4 (- _j0 1)))))))
                                             (___do_loop4 (- _m0 _i0)))
                                          (___do_loop1 (- _n1 1) (if (zero? _i0) _m0 (- _i0 1)) (generate-symbol) _a0))))))
               (___do_loop1 _n0 _m0 (generate-symbol) ()))))))
 
(define browse-random (<change>
      (lambda ()
...
(define my-match (lambda (pat dat alist)
      (if (null? pat)
         (null? dat)
         (if (null? dat)
            ()
...
(define investigate (lambda (units pats)
